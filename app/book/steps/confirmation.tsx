...
export function Confirmation({ state, totalPrice, depositAmount }: Props) {
  return (
    <div className="max-w-md mx-auto text-center py-12">
      ...
      <div className="bg-surface-widget border border-dark-grey rounded-2xl p-6 text-left mb-8">
        <div className="space-y-4">
          ...
          <div className="pt-3 border-t border-surface-widget/50 space-y-1.5">
            ...
            <div className="flex justify-between font-bold pt-1">
              ...
              <span className="text-accent-blue-500">${(totalPrice - depositAmount).toFixed(2)}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* What happens next */}
      <div className="bg-surface-widget border border-dark-grey rounded-2xl p-5 text-left mb-8">
